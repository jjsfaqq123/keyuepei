    ...
    <div class="search_wc">
      <div class="search_nc">
        <div class="search_left">
          上月成交 :
          <span class="number">
            <numberIncrease :min="0" :max="6689" :step="44"></numberIncrease>
          </span>单
          &nbsp; &nbsp;
          本月成交 :
          <span class="number">
            <numberIncrease :min="0" :max="4689" :step="32"></numberIncrease>
          </span>单
          &nbsp; &nbsp;
          今日成交 :
          <span class="number">
            <numberIncrease :min="0" :max="129" :step="1"></numberIncrease>
          </span>单
          &nbsp; &nbsp;
        </div>
...
export default {
  ...
  methods: {
    ...
    close(key,value){
        ...
        this.$router.push({name:"musicExample",query:this.filter});
    },
    renderPage() {
...
.search_right > input {
  ...
  font-size: 18px;
  padding-left: 18px;
  background: url("../assets/imgs/musicExample/搜索.png") no-repeat;
